 ...
 *         
 */
package se.natusoft.annotation.processor.simplified.annotations;
...
/**
 * This annotation specifies that the annotted method should be called when all processing is done.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target(ElementType.METHOD)
public @interface AllProcessed {}
